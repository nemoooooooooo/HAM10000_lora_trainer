...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        action="append",
        default=None,
        help="Validation prompt. Can be passed multiple times to validate against several prompts.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="512",
        help="Either a single int (square) or 'H,W' for rectangular training",
    )
    parser.add_argument(
        "--center_crop",
        default=False,
    ...
    # --- Normalize validation prompts into args.validation_prompts (list[str]) ---
    validation_prompts: List[str] = []

    # collect from repeated --validation_prompt
    if args.validation_prompt:
        # action='append' yields a list; flatten any accidental empties/whitespace
        for p in args.validation_prompt:
            if p and p.strip():
                validation_prompts.append(p.strip())
